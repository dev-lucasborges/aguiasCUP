...
const Login = () => {
  ...
  return (
    ...
    <SafeAreaView style={{backgroundColor: "#000"}}>
            ...
            />
            <View>
            <Text style={{color: "#FFF", fontWeight: 700, fontSize: 40, marginLeft: 30, marginTop: 30}}>
              Olá, Manager!
            </Text>
            <Text style={{color:"#727380", fontWeight: 500, fontSize:25, marginLeft: 30}}> 
    ...
    <KeyboardAvoidingView
      ...
      >
    <SafeAreaView style={{backgroundColor: "#000", color: "#FFF", flex: 1, alignItems: "center", justifyContent: "flex-end"}}>
      <View style={{width: "90%"}}>
      <TextInput
      style={{
        padding: 15,
      ...
      />
        ...
        <Text style={{fontWeight: 600}}>Fazer Login</Text>
        </View>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
